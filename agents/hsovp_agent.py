...
from model.hso_vp import Decoder
...
class HsOVPAgent:
    ...
    def setup(self, path_to_conf_file):
        ...
        # model
        # high policy: pi(z|s)
        self.high_policy = GaussianPolicy(cfg.model.state_dim, cfg.model.measurement_dim, cfg.model.latent_dim, cfg.model.action_dim)
        # low policy: p(a|s, z)
        self.low_policy = Decoder(cfg.model.state_dim, cfg.model.measurement_dim, cfg.model.latent_dim, cfg.model.action_dim)
        ...
        self.low_policy.load_state_dict(low_policy_ckpt['decoder_state_dict'])
